...
router.get("/stats", authMiddleWare, validate(queryDaysSchema, "query"), dashboardController);
...
router.get("/:id/charts", authMiddleWare, validate(linkIdSchema, "params"), validate(queryDaysSchema, "query"), chartController);
