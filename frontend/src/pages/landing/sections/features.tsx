...
const features = [
  {
    ...
    body: "Compress any URL into a clean, memorable link. Choose your own slug, keep the destination editable forever, and change targets without breaking what you've already shared.",
    tag: "CORE",
  },
  {
    n: "02",
    ...
    body: "Clicks, scans, referrers and geography — recorded per link and surfaced in a ledger that respects your attention instead of decorating it.",
    tag: "DATA",
  },
  {
    n: "03",
    ...
    body: "Every link ships with a matching QR code. Print it, embed it, restyle it — the destination updates centrally, so nothing on paper ever goes stale.",
    tag: "QR",
  },
  {
    n: "04",
    ...
    body: "Connect a custom domain and every short link becomes yours — no third-party branding between you and your audience. Verification is built in.",
    tag: "DNS",
  },
];
