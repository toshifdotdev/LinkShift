    ...
    },
    {
        ...
        topics: [
            ...
            },
            {
                ...
                summary: "One short link that carries whatever path and query a visitor appends through to your destination. URL forwarding — not app opening.",
                body: [
                    {
                        kind: "p",
            ...
            },
            {
                ...
                summary: "Try to open your mobile app when a visitor arrives on a phone — with a website or store fallback when it isn't installed.",
                body: [
                    {
                        kind: "p",
...
export const ALL_TOPICS = DOC_CATEGORIES.flatMap((category) => category.topics.map((topic) => ({ category, topic })));
